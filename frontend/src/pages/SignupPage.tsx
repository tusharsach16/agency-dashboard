      ...
      <div className="w-full max-w-md bg-card-light dark:bg-card-dark border border-black/10 dark:border-white/10 rounded-2xl shadow-soft-light dark:shadow-soft-dark p-8 md:p-10 relative z-10">
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
            Join your agency's real-time project workspace
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 rounded-xl bg-black/[0.02] dark:bg-card-dark border border-black/10 dark:border-white/10 text-slate-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/40 focus:border-amber-500 transition-all cursor-pointer"
            >
              <option value="DEVELOPER">Developer (Assigned tasks focus)</option>
              <option value="PM">Project Manager (Project & task lead)</option>
              <option value="ADMIN">Admin (Full global governance)</option>
            </select>
          </div>
